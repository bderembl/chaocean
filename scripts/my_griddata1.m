function [xi,tri,w] = my_griddata1(x,y,z,xi,yi,options)
...
if sum(ind) > 0
  ...
  z = z(~ind(2:end));
    ...
    [zi,tri,w] = linear(x,y,z,xi,yi,opt);
    %    [itri] = my_griddata3(x,y);
...
%------------------------------------------------------------
function [zi,tri,w] = linear(x,y,z,xi,yi,opt)
